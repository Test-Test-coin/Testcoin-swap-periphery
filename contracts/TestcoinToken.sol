...
import '../../Testcoin-swap-lib/contracts/token/BEP20/BEP20.sol';

contract TestcoinToken is BEP20('TestcoinToken', 'TESTC') {
    /// @notice Creates `_amount` token to `_to`. Must only be called by the owner (TestcoinMaster).
